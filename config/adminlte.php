...
return [
    ...
    */
    ...
    'menu' => [
        ...
        ['header' => 'employee_list_management'],
        [
            'text' => 'employees',
            'url' => '#',
            'icon' => 'fas fa-fw fa-user',
            'active' => ['regex:@^dashboard/employees/[0-9]+/edit$@'],
            'submenu' => [
                [
                    'text' => 'employees_list',
                    'url' => 'dashboard',
                    ...
                    'active' => [
                        'dashboard',
                        'dashboard/employees',
                        'regex:@^dashboard/page/[0-9]+$@',
                        'regex:@^dashboard/employees/page/[0-9]+$@',
                    ],
                ],
                [
                    'text' => 'add_employee',
        ...
        ['header' => 'positions_list_management'],
        [
            'text' => 'positions',
            'url' => 'dashboard/positions',
            'icon' => 'fas fa-fw fa-book',
            'active' => ['regex:@^dashboard/positions/[0-9]+/edit$@'],
            'submenu' => [
                [
                    'text' => 'positions_list',
                    'url' => 'dashboard/positions',
                    ...
                    'active' => [
                        'dashboard/positions',
                        'regex:@^dashboard/positions/page/[0-9]+$@'
                    ]
                ],
                [
                    'text' => 'add_position',
                    'url' => 'dashboard/positions/create',
                    'icon' => 'fas fa-fw fa-plus',
                ],
            ]
        ],
        ...
        'Validation' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/jquery-validation@1.19.2/dist/jquery.validate.min.js',
                ],
            ]
        ],
        'InputMask' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//rawgit.com/RobinHerbots/Inputmask/4.x/dist/jquery.inputmask.bundle.js',
                ],
            ]
        ],
        'DateRangePicker' => [
